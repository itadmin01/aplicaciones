...
class FacturaCliente(http.Controller):
    ...
    def index(self, **kw):
        return http.request.render('website_self_cfdi_invoice_ee_multi.index',
            {
                'fields': ['RFC','Folio',],
            })
    ...
    def my_fact_portal_insert(self, **kwargs):
        ...
        if not rfc_partner or not order_number: # or not mail_to:
            return http.request.render('website_self_cfdi_invoice_ee_multi.html_result_error_inv', {'errores':['Los campos marcados con un ( * ) son Obligatorios.']})
    ...
    def request_invoice(self, **kwargs):
        ...
        try:
            ...
            if auto_invoice:
                ...
                return http.request.render('website_self_cfdi_invoice_ee_multi.html_result_error_inv', {'errores':[error_message]})
